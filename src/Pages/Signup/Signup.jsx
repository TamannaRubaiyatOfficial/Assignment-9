...
const Signup = () => {
    ...
    const handleSignUp = (event) => {
        ...
        console.log(`Name: ${name} \nEmail: ${email} \nImage-URL: ${image} \nPassword: ${password}`, { name, email, image, password });
        ...
        toast.promise(
            ...
            {
                loading: "Setting up your cozy account...",
                success: "Account created successfully! Welcome to WarmPaws 🐾🧡🧡",
                error: "Oops! Couldn't create account 😢. Try Again !!",
            }
        )
            .then((userCredential) => {
    ...
    const handleGoogleSignIn = () => {
        ...
        signInWithPopup(auth, googleProvider)
            ...
            .catch(error => {
                ...
                console.log("error msz", errorCode, errorMessage, email, credential);
